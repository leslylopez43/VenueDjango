...
# Define your default static and media settings for local development.
STATIC_URL = '/static/'
...
# Check if you're using AWS for static and media files.
if 'USE_AWS' in os.environ:
    # Configure AWS settings for production.
    ...
    # Define cache control settings for S3.
